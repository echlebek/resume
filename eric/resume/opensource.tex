...
\begin{cventries}
  \cventry
    {Contributer}
    {\href{https://github.com/open-telemetry/opentelemetry-collector-contrib}{opentelemetry-collector-contrib}}
    {MIT License}
    {2024-2025}
    {
		\begin{cvitems}
  		  \item{Code owner for Sumo Logic's open-telemetry components (receiver, processor, exporter)}
		  \item{Contributed to redis receiver, adding additional metrics}
		  \item{Helped with project-wide maintenance efforts for owned components}
		  \item{Kept owned components up to date with overall project trends}
		  \item{Attended community SIG meetings and worked with other members on shared problems}
		\end{cvitems}
	}
